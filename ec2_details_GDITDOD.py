...
ec2_details_list_fname     = OUTPUT_FILE_DIR + "gdit_ec2_details_list_"  +  str(exTractDateTime)  +  ".csv"
ec2_details_list_err_fname = OUTPUT_FILE_DIR + "gdit_ec2_details_list_err_"  +  str(exTractDateTime)  +  ".csv"
